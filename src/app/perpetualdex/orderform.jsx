...
import PopSlider from './PopRangeSlider';
...
const Orderform = () => {
    ...
    return (
        <div className="orderform griddragoption" id="orderformtabshow">
            ...
            <Modal show={showModal3} onHide={handleClose3} className='modalbgt authmodal pop-range' aria-labelledby="contained-modal-title-vcenter"
                centered>
                <Modal.Header closeButton>
                    <Modal.Title id="contained-modal-title-vcenter">
                        Adjust Leverage
